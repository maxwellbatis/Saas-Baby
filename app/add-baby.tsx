...
export default function AddBabyScreen() {
  ...
  const handleAddBaby = async () => {
    ...
    if (response.success && response.data) {
      Alert.alert('Sucesso', 'Bebê adicionado com sucesso!');
      router.back();
    } else {
      Alert.alert('Erro ao adicionar bebê', response.message || response.error || 'Tente novamente.');
    }
  };
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        <Text style={[styles.title, { color: colors.primary }]}>Adicionar Bebê</Text>
